...
- Tagged releases through v0.7.9
- Published `pictovap` package on PyPI
- Green main-branch CI and release workflows for v0.7.9
...
2. Direct provider and CMS contributors to the v0.7.9 scaffold, runtime, and contract test kit.
