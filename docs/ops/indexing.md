...
```
/Users/username/Projects/Pictovap/
  data/
...
python3 - <<'PY'
import sqlite3
db = "/Users/username/Projects/Pictovap/data/visual_memory.db"
...
0 3 * * * cd /Users/username/Projects/Pictovap && ./.venv/bin/python index_memory_daily.py --mode photos --daily-limit 200 >> /tmp/pictova-index.log 2>&1
```
