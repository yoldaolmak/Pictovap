...
4. Paste the generated feedback Markdown into issue #8. It includes safe
   OS/Python metadata and excludes article text, private paths, image URLs,
   profile names, and credentials.
